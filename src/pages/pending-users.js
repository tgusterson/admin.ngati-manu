  ...
  return (
    <div>
      <Layout>
        ...
        <p>
          Use this page to review pending applications from the Ngati Manu
          website.
        </p>
        <ol>
          ...
          <li>
            Within the application details screen, choose to either 'Approve' or
            'Reject' the application (or hit 'Close' if you want to decide
            later).
          </li>
        </ol>
        ...
        <div>
          ...
          {/* {users.length === 0 && typeof users === "object" && !loading && (
            <p>Click 'Get Pending Users' to get started.</p>
          )} */}
        </div>
      </Layout>
    </div>
